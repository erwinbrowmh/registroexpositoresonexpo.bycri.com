...
<head>
    ...
    <title>404 - Página No Encontrada | ONEXPO 2026</title>
...
<body>
    <div class="error-container">
        ...
        <div class="mt-4 pt-3 border-top">
            <small class="text-muted">Si crees que esto es un error, por favor contacta a soporte.</small>
        </div>
    </div>
</body>
</html>
