...
--
-- Servidor: localhost
-- Tiempo de generación: 20-02-2026 a las 16:14:59
...
CREATE TABLE `expositores` (
  ...
  `acceso` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `transplano` (
  ...
  `tipo_usuario` enum('administrador','capturista','staff','expositor') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `id_usuario` int(11) NOT NULL,
  `usuario` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
